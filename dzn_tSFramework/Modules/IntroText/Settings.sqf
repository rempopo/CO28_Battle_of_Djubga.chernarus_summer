...
// 2nd line
GVAR(LineText2)	= "Предместья Джубги, Туапсинский муниципальный район, Краснодарский край, Российская Федерация, Черноморский регион";
GVAR(LineStyle2) = "<t align = 'right' shadow = '1' size = '0.7' font='PuristaBold'><br />%1</t>";

// 3rd line
GVAR(LineText3) = "Битва при Джубге";
